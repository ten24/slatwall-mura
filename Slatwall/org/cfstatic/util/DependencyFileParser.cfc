<cfcomponent output="false" extends="Slatwall.org.cfstatic.util.Base" hint="I provide an interface for parsing the CfStatic Dependency file">
	...
	<cffunction name="_discoverFilesFromWildCardMapping" access="private" returntype="array" output="false">
		...
		<cfscript>
			...
			if ( not ArrayLen( returnArray ) ) {
				$throw(  type    = "Slatwall.org.cfstatic.util.DependencyFileParser.missingDependency"
