<cfcomponent output="false" extends="Slatwall.org.cfstatic.util.Base" hint="I am a CF wrapper to the YuiCompressor jar">
	...
	<cffunction name="init" access="public" returntype="Slatwall.org.cfstatic.util.CoffeeScriptCompiler" output="false" hint="Constructor, taking a javaloader instance preloaded with the path to the Less Compiler jar.">
	...
	<cffunction name="compile" access="public" returntype="string" output="false">
		...
		<cfscript>
			...
			try {
				...
				$throw( 'Slatwall.org.cfstatic.util.CoffeeScriptCompiler.badCoffee', 'There was a problem with your coffee-script file, #ListLast(arguments.filePath, "\/")#. Message: #e.message#', e.detail );
			}
		</cfscript>
	</cffunction>
