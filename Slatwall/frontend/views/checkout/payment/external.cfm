...
<cfoutput>
	<div class="svocheckoutpaymentexternal">
		<cfinclude template="#params.paymentMethod.getPaymentIntegration().getIntegrationCFC("payment").getExternalPaymentCheckoutViewPath()#" />
	</div>
</cfoutput>